...
INSERT INTO `aluno` VALUES (2,'3453534','Kaio','(21) 9999-9999','Noturno',NULL,NULL),(3,'111111111','Mariah','(99) 9999-9999','Noturno',NULL,NULL),(4,'12312','AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA','(21) 6465-4645','Noturno',NULL,NULL);
...
INSERT INTO `empresa` VALUES (1,'Faetec','faetec1@gmail.com');
...
INSERT INTO `flyway_schema_history` VALUES (1,'1','<< Flyway Baseline >>','BASELINE','<< Flyway Baseline >>',NULL,'root','2024-04-22 23:31:20',0,1),(2,'1','estagio','SQL','V1__estagio.sql',495765351,'root','2024-05-07 23:53:19',278,1),(3,'2','estagio','SQL','V2__estagio.sql',1002021297,'root','2024-05-22 18:46:46',12097,1);
...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `empresa_id` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id_empresa`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-22 16:40:05
